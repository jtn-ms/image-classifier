...
if __name__ == '__main__':
    ...
    output_dir = '/media/frank/Data/Models/caffe/imagenet/triplet/'#'data/models/triplet/'
    pretrained_model = '/home/frank/digits/digits/jobs/20170512-094225-5658/snapshot_iter_2820.caffemodel'#'data/models/softmax/snapshot_iter_3696.caffemodel'#'data/models/triplet/top/alexnet_triplet_loss_132_0.2_pure.caffemodel'#
    gpu_id = 0
    data = sampledata()
